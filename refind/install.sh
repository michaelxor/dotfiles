...
run_refind() {
    ...
    # having trouble  getting curl to work here, everything i've seen
    # mentioning curl from sourceforge says the -L flag should do the
    # trick, still no luck though...
    #curl -Lo ${LOCAL_NAME} ${URL_BASE}
    ...
    if [[ $(fdesetup status) == 'FileVault is On.' ]]; then
        ...
        # we also need to uncommend dont_scan_volumes and
